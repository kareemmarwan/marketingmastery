...
const testimonials = [
  {
    name: "ليلى أحمد",
    role: "طالبة جامعية",
    content: "كنت أظن أن بدء مشروع يحتاج رأس مال كبير، لكن هذا الكتاب غيّر نظرتي، وبفضله بدأت أول مشروع لي خلال أقل من شهر.",
    rating: 5,
    initials: "لأ"
  },
  {
    name: "خالد محمود",
    role: "موظف بدخل محدود",
    content:
      "أكثر ما أعجبني هو الوضوح والعملية. لا حشو ولا تنظير، فقط خطوات واضحة ساعدتني على استثمار مبلغ بسيط وتحقيق أول دخل إضافي حقيقي."
    ,
    rating: 5,
    initials: "خم"
  },
  {
    name: "منى علي",
    role: "رائدة أعمال مبتدئة",
    content:
      "الكتاب ساعدني على اختيار فكرة مناسبة لي وتجنب أخطاء كلفت غيري الكثير. خطة الـ30 يوم كانت نقطة التحول وبفضلها بدأت بثقة."
    ,
    rating: 5,
    initials: "مأ"
  }
